...
void raylib_lua_sol_enums(sol::state &lua) {
  ...
  lua.new_enum("KeyboardKey",
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_APOSTROPHE),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_COMMA),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_MINUS),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_PERIOD),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_SLASH),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_ZERO),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_ONE),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_TWO),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_THREE),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_FOUR),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_FIVE),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_SIX),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_SEVEN),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_EIGHT),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_NINE),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_SEMICOLON),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_EQUAL),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_A),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_B),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_C),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_D),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_E),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_F),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_G),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_H),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_I),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_J),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_K),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_L),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_M),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_N),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_O),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_P),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_Q),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_R),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_S),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_T),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_U),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_V),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_W),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_X),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_Y),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_Z),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_SPACE),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_ESCAPE),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_ENTER),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_TAB),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_BACKSPACE),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_INSERT),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_DELETE),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_RIGHT),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_LEFT),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_DOWN),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_UP),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_PAGE_UP),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_PAGE_DOWN),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_HOME),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_END),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_CAPS_LOCK),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_SCROLL_LOCK),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_NUM_LOCK),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_PRINT_SCREEN),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_PAUSE),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_F1),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_F2),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_F3),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_F4),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_F5),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_F6),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_F7),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_F8),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_F9),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_F10),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_F11),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_F12),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_LEFT_SHIFT),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_LEFT_CONTROL),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_LEFT_ALT),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_LEFT_SUPER),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_RIGHT_SHIFT),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_RIGHT_CONTROL),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_RIGHT_ALT),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_RIGHT_SUPER),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_KB_MENU),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_LEFT_BRACKET),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_BACKSLASH),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_RIGHT_BRACKET),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_GRAVE),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_KP_0),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_KP_1),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_KP_2),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_KP_3),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_KP_4),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_KP_5),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_KP_6),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_KP_7),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_KP_8),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_KP_9),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_KP_DECIMAL),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_KP_DIVIDE),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_KP_MULTIPLY),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_KP_SUBTRACT),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_KP_ADD),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_KP_ENTER),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_KP_EQUAL)
  );

  lua.new_enum("AndroidButton",
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_BACK),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_MENU),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_VOLUME_UP),
    RAYLIB_LUA_SOL2_ENUM_DEF(KEY_VOLUME_DOWN)
  );

  lua.new_enum("MouseButton",
    RAYLIB_LUA_SOL2_ENUM_DEF(MOUSE_LEFT_BUTTON),
    RAYLIB_LUA_SOL2_ENUM_DEF(MOUSE_RIGHT_BUTTON),
    RAYLIB_LUA_SOL2_ENUM_DEF(MOUSE_MIDDLE_BUTTON)
  );

  lua.new_enum("GamepadNumber",
    RAYLIB_LUA_SOL2_ENUM_DEF(GAMEPAD_PLAYER1),
    RAYLIB_LUA_SOL2_ENUM_DEF(GAMEPAD_PLAYER2),
    RAYLIB_LUA_SOL2_ENUM_DEF(GAMEPAD_PLAYER3),
    RAYLIB_LUA_SOL2_ENUM_DEF(GAMEPAD_PLAYER4)
  );

  lua.new_enum("GamepadButton",
    RAYLIB_LUA_SOL2_ENUM_DEF(GAMEPAD_BUTTON_UNKNOWN),
    RAYLIB_LUA_SOL2_ENUM_DEF(GAMEPAD_BUTTON_LEFT_FACE_UP),
    RAYLIB_LUA_SOL2_ENUM_DEF(GAMEPAD_BUTTON_LEFT_FACE_RIGHT),
    RAYLIB_LUA_SOL2_ENUM_DEF(GAMEPAD_BUTTON_LEFT_FACE_DOWN),
    RAYLIB_LUA_SOL2_ENUM_DEF(GAMEPAD_BUTTON_LEFT_FACE_LEFT),
    RAYLIB_LUA_SOL2_ENUM_DEF(GAMEPAD_BUTTON_RIGHT_FACE_UP),
    RAYLIB_LUA_SOL2_ENUM_DEF(GAMEPAD_BUTTON_RIGHT_FACE_RIGHT),
    RAYLIB_LUA_SOL2_ENUM_DEF(GAMEPAD_BUTTON_RIGHT_FACE_DOWN),
    RAYLIB_LUA_SOL2_ENUM_DEF(GAMEPAD_BUTTON_RIGHT_FACE_LEFT),
    RAYLIB_LUA_SOL2_ENUM_DEF(GAMEPAD_BUTTON_LEFT_TRIGGER_1),
    RAYLIB_LUA_SOL2_ENUM_DEF(GAMEPAD_BUTTON_LEFT_TRIGGER_2),
    RAYLIB_LUA_SOL2_ENUM_DEF(GAMEPAD_BUTTON_RIGHT_TRIGGER_1),
    RAYLIB_LUA_SOL2_ENUM_DEF(GAMEPAD_BUTTON_RIGHT_TRIGGER_2),
    RAYLIB_LUA_SOL2_ENUM_DEF(GAMEPAD_BUTTON_MIDDLE_LEFT),
    RAYLIB_LUA_SOL2_ENUM_DEF(GAMEPAD_BUTTON_MIDDLE),
    RAYLIB_LUA_SOL2_ENUM_DEF(GAMEPAD_BUTTON_MIDDLE_RIGHT),
    RAYLIB_LUA_SOL2_ENUM_DEF(GAMEPAD_BUTTON_LEFT_THUMB),
    RAYLIB_LUA_SOL2_ENUM_DEF(GAMEPAD_BUTTON_RIGHT_THUMB)
  );

  lua.new_enum("GamepadAxis",
    RAYLIB_LUA_SOL2_ENUM_DEF(GAMEPAD_AXIS_UNKNOWN),
    RAYLIB_LUA_SOL2_ENUM_DEF(GAMEPAD_AXIS_LEFT_X),
    RAYLIB_LUA_SOL2_ENUM_DEF(GAMEPAD_AXIS_LEFT_Y),
    RAYLIB_LUA_SOL2_ENUM_DEF(GAMEPAD_AXIS_RIGHT_X),
    RAYLIB_LUA_SOL2_ENUM_DEF(GAMEPAD_AXIS_RIGHT_Y),
    RAYLIB_LUA_SOL2_ENUM_DEF(GAMEPAD_AXIS_LEFT_TRIGGER),
    RAYLIB_LUA_SOL2_ENUM_DEF(GAMEPAD_AXIS_RIGHT_TRIGGER)
  );

  lua.new_enum("ShaderLocationIndex",
    RAYLIB_LUA_SOL2_ENUM_DEF(LOC_VERTEX_POSITION),
    RAYLIB_LUA_SOL2_ENUM_DEF(LOC_VERTEX_TEXCOORD01),
    RAYLIB_LUA_SOL2_ENUM_DEF(LOC_VERTEX_TEXCOORD02),
    RAYLIB_LUA_SOL2_ENUM_DEF(LOC_VERTEX_NORMAL),
    RAYLIB_LUA_SOL2_ENUM_DEF(LOC_VERTEX_TANGENT),
    RAYLIB_LUA_SOL2_ENUM_DEF(LOC_VERTEX_COLOR),
    RAYLIB_LUA_SOL2_ENUM_DEF(LOC_MATRIX_MVP),
    RAYLIB_LUA_SOL2_ENUM_DEF(LOC_MATRIX_MODEL),
    RAYLIB_LUA_SOL2_ENUM_DEF(LOC_MATRIX_VIEW),
    RAYLIB_LUA_SOL2_ENUM_DEF(LOC_MATRIX_PROJECTION),
    RAYLIB_LUA_SOL2_ENUM_DEF(LOC_VECTOR_VIEW),
    RAYLIB_LUA_SOL2_ENUM_DEF(LOC_COLOR_DIFFUSE),
    RAYLIB_LUA_SOL2_ENUM_DEF(LOC_COLOR_SPECULAR),
    RAYLIB_LUA_SOL2_ENUM_DEF(LOC_COLOR_AMBIENT),
    RAYLIB_LUA_SOL2_ENUM_DEF(LOC_MAP_ALBEDO),
    RAYLIB_LUA_SOL2_ENUM_DEF(LOC_MAP_METALNESS),
    RAYLIB_LUA_SOL2_ENUM_DEF(LOC_MAP_NORMAL),
    RAYLIB_LUA_SOL2_ENUM_DEF(LOC_MAP_ROUGHNESS),
    RAYLIB_LUA_SOL2_ENUM_DEF(LOC_MAP_OCCLUSION),
    RAYLIB_LUA_SOL2_ENUM_DEF(LOC_MAP_EMISSION),
    RAYLIB_LUA_SOL2_ENUM_DEF(LOC_MAP_HEIGHT),
    RAYLIB_LUA_SOL2_ENUM_DEF(LOC_MAP_CUBEMAP),
    RAYLIB_LUA_SOL2_ENUM_DEF(LOC_MAP_IRRADIANCE),
    RAYLIB_LUA_SOL2_ENUM_DEF(LOC_MAP_PREFILTER),
    RAYLIB_LUA_SOL2_ENUM_DEF(LOC_MAP_BRDF),
    "LOC_MAP_DIFFUSE", LOC_MAP_ALBEDO,
    "LOC_MAP_SPECULAR", LOC_MAP_METALNESS
  );

  lua.new_enum("ShaderUniformDataType",
    RAYLIB_LUA_SOL2_ENUM_DEF(UNIFORM_FLOAT),
    RAYLIB_LUA_SOL2_ENUM_DEF(UNIFORM_VEC2),
    RAYLIB_LUA_SOL2_ENUM_DEF(UNIFORM_VEC3),
    RAYLIB_LUA_SOL2_ENUM_DEF(UNIFORM_VEC4),
    RAYLIB_LUA_SOL2_ENUM_DEF(UNIFORM_INT),
    RAYLIB_LUA_SOL2_ENUM_DEF(UNIFORM_IVEC2),
    RAYLIB_LUA_SOL2_ENUM_DEF(UNIFORM_IVEC3),
    RAYLIB_LUA_SOL2_ENUM_DEF(UNIFORM_IVEC4),
    RAYLIB_LUA_SOL2_ENUM_DEF(UNIFORM_SAMPLER2D)
  );

  lua.new_enum("MaterialMapType",
    RAYLIB_LUA_SOL2_ENUM_DEF(MAP_ALBEDO),
    RAYLIB_LUA_SOL2_ENUM_DEF(MAP_METALNESS),
    RAYLIB_LUA_SOL2_ENUM_DEF(MAP_NORMAL),
    RAYLIB_LUA_SOL2_ENUM_DEF(MAP_ROUGHNESS),
    RAYLIB_LUA_SOL2_ENUM_DEF(MAP_OCCLUSION),
    RAYLIB_LUA_SOL2_ENUM_DEF(MAP_EMISSION),
    RAYLIB_LUA_SOL2_ENUM_DEF(MAP_HEIGHT),
    RAYLIB_LUA_SOL2_ENUM_DEF(MAP_CUBEMAP),
    RAYLIB_LUA_SOL2_ENUM_DEF(MAP_IRRADIANCE),
    RAYLIB_LUA_SOL2_ENUM_DEF(MAP_PREFILTER),
    RAYLIB_LUA_SOL2_ENUM_DEF(MAP_BRDF),
    "MAP_DIFFUSE", MAP_ALBEDO,
    "MAP_SPECULAR", MAP_METALNESS
  );

  lua.new_enum("PixelFormat",
    RAYLIB_LUA_SOL2_ENUM_DEF(UNCOMPRESSED_GRAYSCALE),
    RAYLIB_LUA_SOL2_ENUM_DEF(UNCOMPRESSED_GRAY_ALPHA),
    RAYLIB_LUA_SOL2_ENUM_DEF(UNCOMPRESSED_R5G6B5),
    RAYLIB_LUA_SOL2_ENUM_DEF(UNCOMPRESSED_R8G8B8),
    RAYLIB_LUA_SOL2_ENUM_DEF(UNCOMPRESSED_R5G5B5A1),
    RAYLIB_LUA_SOL2_ENUM_DEF(UNCOMPRESSED_R4G4B4A4),
    RAYLIB_LUA_SOL2_ENUM_DEF(UNCOMPRESSED_R8G8B8A8),
    RAYLIB_LUA_SOL2_ENUM_DEF(UNCOMPRESSED_R32),
    RAYLIB_LUA_SOL2_ENUM_DEF(UNCOMPRESSED_R32G32B32),
    RAYLIB_LUA_SOL2_ENUM_DEF(UNCOMPRESSED_R32G32B32A32),
    RAYLIB_LUA_SOL2_ENUM_DEF(COMPRESSED_DXT1_RGB),
    RAYLIB_LUA_SOL2_ENUM_DEF(COMPRESSED_DXT1_RGBA),
    RAYLIB_LUA_SOL2_ENUM_DEF(COMPRESSED_DXT3_RGBA),
    RAYLIB_LUA_SOL2_ENUM_DEF(COMPRESSED_DXT5_RGBA),
    RAYLIB_LUA_SOL2_ENUM_DEF(COMPRESSED_ETC1_RGB),
    RAYLIB_LUA_SOL2_ENUM_DEF(COMPRESSED_ETC2_RGB),
    RAYLIB_LUA_SOL2_ENUM_DEF(COMPRESSED_ETC2_EAC_RGBA),
    RAYLIB_LUA_SOL2_ENUM_DEF(COMPRESSED_PVRT_RGB),
    RAYLIB_LUA_SOL2_ENUM_DEF(COMPRESSED_PVRT_RGBA),
    RAYLIB_LUA_SOL2_ENUM_DEF(COMPRESSED_ASTC_4x4_RGBA),
    RAYLIB_LUA_SOL2_ENUM_DEF(COMPRESSED_ASTC_8x8_RGBA)
  );

  lua.new_enum("TextureFilterMode",
    RAYLIB_LUA_SOL2_ENUM_DEF(FILTER_POINT),
    RAYLIB_LUA_SOL2_ENUM_DEF(FILTER_BILINEAR),
    RAYLIB_LUA_SOL2_ENUM_DEF(FILTER_TRILINEAR),
    RAYLIB_LUA_SOL2_ENUM_DEF(FILTER_ANISOTROPIC_4X),
    RAYLIB_LUA_SOL2_ENUM_DEF(FILTER_ANISOTROPIC_8X),
    RAYLIB_LUA_SOL2_ENUM_DEF(FILTER_ANISOTROPIC_16X)
  );

  lua.new_enum("CubemapLayoutType",
    RAYLIB_LUA_SOL2_ENUM_DEF(CUBEMAP_AUTO_DETECT),
    RAYLIB_LUA_SOL2_ENUM_DEF(CUBEMAP_LINE_VERTICAL),
    RAYLIB_LUA_SOL2_ENUM_DEF(CUBEMAP_LINE_HORIZONTAL),
    RAYLIB_LUA_SOL2_ENUM_DEF(CUBEMAP_CROSS_THREE_BY_FOUR),
    RAYLIB_LUA_SOL2_ENUM_DEF(CUBEMAP_CROSS_FOUR_BY_THREE),
    RAYLIB_LUA_SOL2_ENUM_DEF(CUBEMAP_PANORAMA)
  );

  lua.new_enum("TextureWrapMode",
    RAYLIB_LUA_SOL2_ENUM_DEF(WRAP_REPEAT),
    RAYLIB_LUA_SOL2_ENUM_DEF(WRAP_CLAMP),
    RAYLIB_LUA_SOL2_ENUM_DEF(WRAP_MIRROR_REPEAT),
    RAYLIB_LUA_SOL2_ENUM_DEF(WRAP_MIRROR_CLAMP)
  );

  lua.new_enum("FontType",
    RAYLIB_LUA_SOL2_ENUM_DEF(FONT_DEFAULT),
    RAYLIB_LUA_SOL2_ENUM_DEF(FONT_BITMAP),
    RAYLIB_LUA_SOL2_ENUM_DEF(FONT_SDF)
  );

  lua.new_enum("BlendMode",
    RAYLIB_LUA_SOL2_ENUM_DEF(BLEND_ALPHA),
    RAYLIB_LUA_SOL2_ENUM_DEF(BLEND_ADDITIVE),
    RAYLIB_LUA_SOL2_ENUM_DEF(BLEND_MULTIPLIED)
  );


  lua.new_enum("GestureType",
    RAYLIB_LUA_SOL2_ENUM_DEF(GESTURE_NONE),
    RAYLIB_LUA_SOL2_ENUM_DEF(GESTURE_TAP),
    RAYLIB_LUA_SOL2_ENUM_DEF(GESTURE_DOUBLETAP),
    RAYLIB_LUA_SOL2_ENUM_DEF(GESTURE_HOLD),
    RAYLIB_LUA_SOL2_ENUM_DEF(GESTURE_DRAG),
    RAYLIB_LUA_SOL2_ENUM_DEF(GESTURE_SWIPE_RIGHT),
    RAYLIB_LUA_SOL2_ENUM_DEF(GESTURE_SWIPE_LEFT),
    RAYLIB_LUA_SOL2_ENUM_DEF(GESTURE_SWIPE_UP),
    RAYLIB_LUA_SOL2_ENUM_DEF(GESTURE_SWIPE_DOWN),
    RAYLIB_LUA_SOL2_ENUM_DEF(GESTURE_PINCH_IN),
    RAYLIB_LUA_SOL2_ENUM_DEF(GESTURE_PINCH_OUT)
  );

  lua.new_enum("CameraMode",
    RAYLIB_LUA_SOL2_ENUM_DEF(CAMERA_CUSTOM),
    RAYLIB_LUA_SOL2_ENUM_DEF(CAMERA_FREE),
    RAYLIB_LUA_SOL2_ENUM_DEF(CAMERA_ORBITAL),
    RAYLIB_LUA_SOL2_ENUM_DEF(CAMERA_FIRST_PERSON),
    RAYLIB_LUA_SOL2_ENUM_DEF(CAMERA_THIRD_PERSON)
  );

  lua.new_enum("CameraType",
    RAYLIB_LUA_SOL2_ENUM_DEF(CAMERA_PERSPECTIVE),
    RAYLIB_LUA_SOL2_ENUM_DEF(CAMERA_ORTHOGRAPHIC)
  );

  lua.new_enum("NPatchType",
    RAYLIB_LUA_SOL2_ENUM_DEF(NPT_9PATCH),
    RAYLIB_LUA_SOL2_ENUM_DEF(NPT_3PATCH_VERTICAL),
    RAYLIB_LUA_SOL2_ENUM_DEF(NPT_3PATCH_HORIZONTAL)
  );
}
