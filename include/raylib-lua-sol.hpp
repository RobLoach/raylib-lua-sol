...
void raylib_lua_sol_enums(sol::state &lua) {
    ...
    RAYLIB_LUA_SOL_ENUM_DEF(FLAG_SHOW_LOGO),
    RAYLIB_LUA_SOL_ENUM_DEF(FLAG_FULLSCREEN_MODE),
    RAYLIB_LUA_SOL_ENUM_DEF(FLAG_WINDOW_RESIZABLE),
    RAYLIB_LUA_SOL_ENUM_DEF(FLAG_WINDOW_UNDECORATED),
    RAYLIB_LUA_SOL_ENUM_DEF(FLAG_WINDOW_TRANSPARENT),
    RAYLIB_LUA_SOL_ENUM_DEF(FLAG_WINDOW_HIDDEN),
    RAYLIB_LUA_SOL_ENUM_DEF(FLAG_WINDOW_ALWAYS_RUN),
    RAYLIB_LUA_SOL_ENUM_DEF(FLAG_MSAA_4X_HINT),
    RAYLIB_LUA_SOL_ENUM_DEF(FLAG_VSYNC_HINT)
	);
  lua.new_enum("TraceLogType",
    RAYLIB_LUA_SOL_ENUM_DEF(LOG_ALL),
    RAYLIB_LUA_SOL_ENUM_DEF(LOG_TRACE),
    RAYLIB_LUA_SOL_ENUM_DEF(LOG_DEBUG),
    RAYLIB_LUA_SOL_ENUM_DEF(LOG_INFO),
    RAYLIB_LUA_SOL_ENUM_DEF(LOG_WARNING),
    RAYLIB_LUA_SOL_ENUM_DEF(LOG_ERROR),
    RAYLIB_LUA_SOL_ENUM_DEF(LOG_FATAL),
    RAYLIB_LUA_SOL_ENUM_DEF(LOG_NONE)
  );
